public class MotionCheck {
    ...
    /**
     * widthOfOrigin_1 is width of origin in line equation y = x + widthOfOrigin_1
     * widthOfOrigin_2 is width of origin in line equation y = -x + widthOfOrigin_2
     * nutNeighbor is information of the neighbor of the select position
     * distance is information of the neighbor of the select position
     */
    ...
    /**
     *
     * @param move is the temp empty place for checking that this place can be selected by player for creat the line equation for this nut
     */
    ...
    /**
     *
     * @param move is the temp empty place for checking that this place can be selected by player
     * @param map the map of game
     * @return the value of this place is empty or not
     */
     ...
     * @param move is the temp empty place for checking that this place can be selected by player
     * @param map the map of game
     * @param otherPlayer information of rival
     * @return is information of the neighbor of the select position
     */
     ...
     *
     * @param move is the temp empty place for checking that this place can be selected by player
     * @param movePlayer information of the player wants to move
     * @param otherPlayer information of rival
     * @param map the map of game
     */
